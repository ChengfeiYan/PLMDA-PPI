...
## Example
    python predict.py ./example/1Z6O_C.fasta ./example/1Z6O_C.msa.a3m ./example/1Z6O_C.pdb ./example/1Z6O_O.fasta ./example/1Z6O_O_msa.a3m ./example/1Z6O_O.pdb ./example/result PLMDA-PPI(PDB).pt cpu
